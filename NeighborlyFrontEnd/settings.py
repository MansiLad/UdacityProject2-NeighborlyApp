#--------- Flask settings
SERVER_HOST = 'https://frontendp2.azurewebsites.net/' # Update this for the appropriate front-end website when up
SERVER_PORT = 5000
...
API_URL = "https://udacityprojecttwo.azurewebsites.net/api"
